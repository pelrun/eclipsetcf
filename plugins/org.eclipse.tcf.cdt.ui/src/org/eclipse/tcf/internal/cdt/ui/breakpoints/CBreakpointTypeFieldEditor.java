...
public class CBreakpointTypeFieldEditor extends FieldEditor {
    ...
    /**
     * Creates type field editor.
     * @param parent Parent widget.
     * @param label Label for this field editor.
     * @param type Type flag to set within the {@link ICBreakpointType} property.
     */
            ...
            public void run() {
                ...
                service.getCapabilities(null, new IBreakpoints.DoneGetCapabilities() {
                    public void doneGetCapabilities(IToken token, Exception error, Map<String, Object> capabilities) {
                        done( Boolean.TRUE.equals(capabilities.get(fCapability)) );
                    }
                });
            }
        }.getE();
