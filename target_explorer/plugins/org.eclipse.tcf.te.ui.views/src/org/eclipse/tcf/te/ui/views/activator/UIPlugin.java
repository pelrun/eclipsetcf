...
public class UIPlugin extends AbstractUIPlugin {
	...
	protected void initializeImageRegistry(ImageRegistry registry) {
		...
		url = UIPlugin.getDefault().getBundle().getEntry(ImageConsts.IMAGE_DIR_ROOT + ImageConsts.IMAGE_DIR_ETOOL + "menu.gif"); //$NON-NLS-1$
		registry.put(ImageConsts.MENU, ImageDescriptor.createFromURL(url));
